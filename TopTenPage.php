...
<body>
    <nav class="navbar navbar-expand-lg bg-light mb-10">
        <div class="container-fluid ">
            ...
            <div class="collapse navbar-collapse justify-content-md-center" id="navbarNav">
                <ul class="navbar-nav ">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="TopTenPage.php">Top 10 Best</a>
                    </li>
                    <li class="nav-item">
            ...
            <?php foreach ($result as $row) { ?>
                <div class="col">
                    <div class="card h-100">
                        <img src=<?php echo $row["image"] ?> class="card-img-top" style="height: 200px;" alt="...">
                        <div class="card-body">
                        ...
                        <div class="card-footer">
                            <small class="text-muted"><?php echo "Last updated ".$row["time_update"] ?></small>
                        </div>
                    </div>
                </div>
